...
import csv, itertools, os, shutil, sys, glob
sys.path.insert(0, r"C:\Users\walru\OneDrive\Рабочий стол\Portfolio Website\portfolio\FugueSplit_source")
...
SRC = r"C:\Users\walru\OneDrive\Рабочий стол\Portfolio Website\portfolio\fugue"
