...
const projects = [
  {
    ...
    files: [
      { name: "📁 Download my code", url: "MLP_source/Code.zip" },
      {
        ...
        url: "MLP_source/Documentation.docx",
      },
    ],
    featured: true,
  },
  {
    ...
    files: [
      { name: "📁 Download my code", url: "" },
      { name: "📄 Download my documentation", url: "" },
    ],
    featured: false,
  },
  {
    ...
    files: [
      ...
      { name: "📄 Download documentation", url: "" },
    ],
    featured: false,
  },
  {
...

  {
    ...
    files: [
      ...
      { name: "📁 index.html", url: "Website_source" },
